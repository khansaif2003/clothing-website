...
<head>
    ...
    <title>Home | UNIQUE COLLECTION</title>
...
<body style="background: linear-gradient(135deg, peachpuff, powderblue);" onload="totalprice()">


  <header id="header"><!--header-->
    <div class="header_top"><!--header_top-->
    <div class="headrer-top" style="background: linear-gradient(135deg, peachpuff, powderblue); color: white; padding: 20px; margin: 20px 0;">
    <div class="container">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> uniquecollection@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <!-- <a href="<?php echo web_root?>" class="fs-4"> -->
              <a href="<?php echo web_root?>" class="fs-4" style="font-size: 24px; color: black; font-weight: bold;">
...
<head>
    ...
    <style>
        .footer-bottom {
            background: linear-gradient(135deg, peachpuff, powderblue); /* Gradient background */
...
<body>
    ...
    <?php
echo '
<footer id="footer" style="position: relative; bottom: 0; width: 100%; display: flex; justify-content: center; align-items: center;">
    <div class="footer-top" style="background: linear-gradient(135deg, beige, lightsteelblue); color: white; text-align: center; width: 100%;">
        <div class="container" style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
            <div class="">
                <h2 style="font-size: 20px; font-weight: bold;">
                    <span style="color: black;">U-</span>
                    <span style="color: grey;">COLLECTION</span>
                </h2>
                <p style="color: black; font-size:12px;">© 2024 Unique Collection <br>
                <a href="#" style="color: black; text-decoration: none;">All Rights Reserved.</a></p>
            </div>
        </div>
    </div>
</footer>
